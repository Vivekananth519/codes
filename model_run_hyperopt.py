        ...
        for model_type, space in models.items():
            ...
            if self.valid is None:
                ...
                psi, csi = Automation.master_call(
                    ...
                    model=model,
                    prob_bins=None,
                    save_path=f'{model_type}_with_{self.n_trials}_Model_Summary.xlsx',
                    n_bins = 10)
            ...
            with mlflow.start_run(run_name = f'{model_type} Tuned with Optuna using {self.n} trials'):
                ...
                input_example = self.train[self.s_feature].head(), registered_model_name = f'Best {model_type} model for {self.channel} with {self.n} trials')
